...
const Header = () => {
    ...
    return (
        <header className='flex justify-between items-center h-16 p-4 bg-white md:h-20 md:p-6 md:border-b md:border-b-lightBlue desktop:h-24'>
            <div className='flex justify-between items-center gap-4'>
                {viewportWidth < 768 ? <KanbanLogo /> : null}
                <div className='flex justify-between items-center gap-2'>
                    <span className='text-header font-bold'>Platform Launch</span>
